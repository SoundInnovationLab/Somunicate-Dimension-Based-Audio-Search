...
class SomunicateApp:
        ...
        with st.expander("How it Works"):
            ...
            st.markdown("""
                ...
                <ol class='custom-bullet'>
                    ...
                    <li><strong>Receive Your Match:</strong> This algorithm identifies the closest sound to your ratings using two different mathematical techniques:</li>
                    <ul>
                        <li><strong>Euclidean Distance:</strong> A simple yet effective method that calculates the closest match based on direct distance measurements.</li>
                        <li><strong>Mahalanobis Distance:</strong> A more sophisticated method that considers correlations between dimensions for a more accurate match.</li>
                        <ul>
    ...
    @staticmethod
    def find_closest_sounds_euclidean(user_ratings, dimensions, data, user_group_ids, top_n=5):
    ...
    @staticmethod
    def find_closest_sounds_mahalanobis(user_ratings, dimensions, data, inv_cov_matrix, user_group_ids, top_n=5):
        # Filter data to only include the relevant dimensions
        specified_dimensions = data[dimensions]
